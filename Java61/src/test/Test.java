...
import main61.DanhSachSinhVien;
import main61.SinhVien;
	...
	public static void main(String[] args) {
		...
		do {
			...
			if (luaChon == 1) {
				...
				System.out.println("Nhập họ và Ten:");String hoVaTen= sc.nextLine();
				...
				System.out.println("Nhập mã sinh viên:");String maSinhVien= sc.nextLine();
				SinhVien sv = new SinhVien(maSinhVien);
				System.out.println("Xoa sinh viên trong danh sách: "+dssv.xoaSinhVien(sv));
